...
As described by Ksouri et al *(8)*, we define four promoter intervals as follows **Up 1**: [-1500 bp, +200 bp], **Up 2**: [-500 bp, +200 bp], **Up 3**: [-500 bp, 0 bp] and **Up 4**: [0 bp, +200 bp] (see **Figure 1**). 
