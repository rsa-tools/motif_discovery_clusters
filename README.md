...
4.  Set appropriate upstream bounds. Default values are -2000,-1. To replicate the work of Yu et al *(4)* these should be set to 'From' -1000 'To' +200. 
    Without prior knowledge of the upstream region boundaries, the proximal promoter may be defined as windows of variable length, where each one is examined   
    separately (see Note X). As described by Ksouri et al.,  <!--Najla, explica up1-up4-->
